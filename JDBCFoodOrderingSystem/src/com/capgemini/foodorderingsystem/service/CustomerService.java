...
public class CustomerService 
{
	...
	public void customerChoice() 
	{
		...
		while(true)
		{
			...
			System.out.println("2. Cart : order here");
			System.out.println("3. Recharge Wallet Amount");
			...
			{
				System.out.println("Customer ID : "+custId+" logged out.");
				break;
			}
		}
	}
